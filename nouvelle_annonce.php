...
if(!empty($_POST)){
	...
	if(empty($content))
	{
	$bdd->query("INSERT INTO annonce(titre,description_courte,description_longue,prix,categorie_id,pays,ville,adresse,cp)VALUES('$_POST[titre]','$_POST[description_courte]','$_POST[description_longue]','$_POST[prix]','$_POST[categorie_id]','$_POST[pays]','$_POST[ville]','$_POST[adresse]','$_POST[cp]')");
